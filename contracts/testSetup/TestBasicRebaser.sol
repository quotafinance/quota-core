...
contract TestBasicRebaser {
  ...
  uint256 public constant WINDOW_SIZE = 5;
  ...
  uint256 public constant REBASE_DELAY = WINDOW_SIZE * 1 seconds;
  ...
  function recordPrice() public {
    ...
    (bool successETF, uint256 priceETF) = (true, uint256(49603000000).mul(1e10));
    if (!successETF) {
